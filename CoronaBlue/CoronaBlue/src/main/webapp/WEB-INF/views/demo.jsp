...
<!--  header -->
<jsp:include page="/WEB-INF/views/demo/header.jsp"/>
<!--  header -->
...
<!--  navigation -->
      	<jsp:include page="/WEB-INF/views/demo/navigation.jsp"/>
<!--  navigation -->
            ...
            <div class="section animated-row" data-section="slide01">
                <div class="section-inner">
                    <div class="welcome-box">
                        ...
                        <h1 class="welcome-title animate" data-animate="fadeInUp">Corona Blue</h1>
...
<!--  footer -->
<jsp:include page="/WEB-INF/views/demo/footer.jsp"/>
<!--  footer -->