...
//@Configuration
public class CompanyAuthenticationFailureHandler implements AuthenticationFailureHandler {
  ...
  protected void loginFailureCount(String username) {
    //        memberDao.countFailure(username);
    //        int cnt = memberDao.checkFailureCount(username);
    //        if(cnt==3) {
    //          memberDao.disabledUsername(username);
    //        }
  }
