...
<body>
	...
	<main class="main">
		<div class="container">
			...
			<form action="/register_result" method="POST" class="needs-validation"
				novalidate="">
				<div class="row g-3">
					<div class="col-sm-6">
					...
					<div class="col-md-3">
						<label for="experience" class="form-label">경력</label> <input
							...
							id="experience" placeholder="" required="">
							...
							<div class="row">
								<div class="form-check col">
									<label for="java" class="form-check-label mx-3"><i
										...
										class="form-check-input" id="java" value="java" name="specification">
								</div>

								<div class="form-check col">
									<label for="javascript" class="form-check-label mx-3"><i
										class="fa-2x fab fa-js-square"></i></label> <input type="checkbox"
										class="form-check-input" id="javascript" value="javascripte" name="specification">
								</div>
