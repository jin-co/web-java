              ...
              <div class="btn-toolbar mb-2 mb-md-0">
                <div class="btn-group me-2">
                  <form action="/search_result" method="POST">
                    <div class="row">
                      <input name="id" class="form-control col" type="text" placeholder="Search by Id" aria-label="Search">
                      <button type="submit" class="btn btn-sm btn-outline-secondary col">조회</button>
                    </div>
                  </form>
                </div>
              </div>
